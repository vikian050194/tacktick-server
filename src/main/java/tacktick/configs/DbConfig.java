...
@Configuration
@EnableJpaRepositories(basePackages = "tacktick.repositories")
...
public class DbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"tacktick.models"});
    ...
    public Boolean seedData(){
        var strValue = env.getProperty("seedData");
        var boolValue = Boolean.valueOf(strValue);
        return boolValue;
    }
}
...
@Configuration
@Profile("postgesql")
@PropertySource("classpath:persistence-postgesql.properties")
class PostgesqlConfig {
}
